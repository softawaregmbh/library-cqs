...
| [`softaware.CQS.Decorators.OpenTelemetry`](src/softaware.Cqs.Decorators.OpenTelemetry)                                                     | [![NuGet](https://img.shields.io/nuget/v/softaware.CQS.Decorators.OpenTelemetry.svg?style=flat-square)](https://www.nuget.org/packages/softaware.CQS.Decorators.OpenTelemetry/)                                                     | A decorator for command-query architecture, which adds support for OpenTelemetry tracing.                                            |
| [`softaware.CQS.Decorators.OpenTelemetry.DependencyInjection`](src/softaware.Cqs.Decorators.OpenTelemetry.DependencyInjection)             | [![NuGet](https://img.shields.io/nuget/v/softaware.CQS.Decorators.OpenTelemetry.DependencyInjection.svg?style=flat-square)](https://www.nuget.org/packages/softaware.CQS.Decorators.OpenTelemetry.DependencyInjection/)             | Builder extensions for adding decorators to Microsoft's DI.                                                                           |
