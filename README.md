...
| [`softaware.CQS.Analyzers`](src/softaware.Cqs.Analyzers)                                                                             | [![NuGet](https://img.shields.io/nuget/v/softaware.CQS.Anaylzers.svg?style=flat-square)](https://www.nuget.org/packages/softaware.CQS.Analyzers/)                                                                             | Roslyn analyzers that ensure correct usage of the library.                                                                            |
