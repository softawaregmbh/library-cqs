...
internal static class DiagnosticDescriptors
{
    ...
    public static readonly DiagnosticDescriptor NoConfigurationFound = new(
        ...
        defaultSeverity: DiagnosticSeverity.Warning,
        isEnabledByDefault: true,
        description: "The source generator could not find any AddSoftawareCqs() call. Ensure you call services.AddSoftawareCqs(b => b.IncludeTypesFrom(typeof(YourMarkerType))). Suppress this warning with <NoWarn>SACQS004</NoWarn>.");
